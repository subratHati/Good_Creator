        ...
        <div className="w-[300px] rounded-2xl bg-white border border-gray-200 shadow-sm overflow-hidden">
          ...
          <div className="p-5">
            <p className="text-sm leading-relaxed text-gray-700 mb-4">
              🎉 Great work! The collaboration is complete and payment has been processed. Thanks for using GoodCreator.
            </p>
            {reviewSubmitted ? (
      ...
      <div className="bg-white border-b border-gray-200 px-4 py-3 flex items-center gap-3 flex-shrink-0">
        ...
        <button
          onClick={() => {
            ...
            const targetId = user.role === 'brand' ? conversation.creatorId?._id : conversation.brandId?._id;
            const targetPath = user.role === 'brand' ? `/creator/${targetId}` : `/brand/${targetId}`;
            if (targetId) navigate(targetPath);
          }}
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="font-semibold text-gray-900 text-sm truncate">{getOtherPartyName()}</div>
